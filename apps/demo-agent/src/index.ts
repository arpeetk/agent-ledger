...
async function main() {
  ...
  const r3 = await callTool(
    'calendar.create_event',
    {
      ...
      attendees: [
        'alice@mycompany.com', 'bob@mycompany.com', 'carol@mycompany.com',
        'dave@mycompany.com', 'eve@mycompany.com', 'frank@mycompany.com',
        'grace@mycompany.com', 'heidi@mycompany.com', 'ivan@mycompany.com',
        'judy@mycompany.com', 'karl@mycompany.com', 'linda@mycompany.com',
      ],
